...
BOT_TOKEN = environ.get('BOT_TOKEN', "7805202977:AAHZV9Fy2anylkeugUHcJNDMix1NISydobc")
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/+4Kn0EtVom08zYjc9') # How to open tutorial link for verification
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002415507718')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002451804784'))
